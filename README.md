...
Guia mobile/PWA da **Vênus casa de Praia - PB**, com indicações gratuitas de praias, gastronomia, passeios e pontos turísticos.

## Identidade
- Perfil: [@venuscasadepraiapb](https://www.instagram.com/venuscasadepraiapb/)
- Mascote: gatinha da Vênus casa de Praia - PB, exibida discretamente no canto superior do guia.
...
> Ícone do app atualizado para a versão com marcador de localização e a gatinha astronauta.
