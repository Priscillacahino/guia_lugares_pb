...
(() => {
  ...
  function applyGuideLanguage(){
    ...
    document.querySelector('.venus-logo')?.setAttribute('alt',tr('Vênus turista em frente ao Farol do Cabo Branco, em João Pessoa','Vênus turista frente al Farol do Cabo Branco, en João Pessoa'));
